...
public class CustomerController {
    ...
    public String createCustomer(
        ...
        try {
            ...
            System.out.println("✅ Đã tạo khách hàng ID: " + savedCustomer.getId() + " - " + savedCustomer.getName());
    ...
    public String updateCustomer(
        ...
        try {
            ...
            return "redirect:/customers/view-customers?page=0&sortBy=id&sortDirection=desc";
        } catch (NoSuchElementException e) {
            model.addAttribute("error", "Khách hàng không tồn tại: " + e.getMessage());
            model.addAttribute("customer", customer);
            model.addAttribute("page", page);
